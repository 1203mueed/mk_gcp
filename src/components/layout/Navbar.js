...
function Navbar() {
  ...
  const renderMobileMenu = (
    ...
    >
      <MenuItem 
        key="why-solution"
        onClick={() => { navigate('/why-our-solution'); handleMenuClose(); }}
      >
        Why Our Solution
      </MenuItem>
      <MenuItem 
        key="about-us"
        onClick={() => { navigate('/about-us'); handleMenuClose(); }}
      >
        About Us
      </MenuItem>
      <MenuItem 
  ...
  return (
    <AppBar 
      ...
      sx={{ 
        ...
        boxShadow: '0 4px 20px rgba(9, 65, 140, 0.3)'
      }}
    >
        ...
        {!isMobile && (
          <Box sx={{ display: 'flex', gap: 1, mr: 'auto' }}>
            <Button
              ...
              color="inherit"
              sx={{ 
                fontWeight: isActive('/why-our-solution') ? 600 : 500,
                borderRadius: 2,
                px: 2,
                py: 1,
                position: 'relative',
                backgroundColor: isActive('/why-our-solution') ? 'rgba(255, 255, 255, 0.15)' : 'transparent',
                backdropFilter: isActive('/why-our-solution') ? 'blur(10px)' : 'none',
                border: isActive('/why-our-solution') ? '1px solid rgba(255, 255, 255, 0.2)' : '1px solid transparent',
                '&:hover': {
            ...
            <Button
              ...
              sx={{ 
                ...
                py: 1,
                position: 'relative',
                backgroundColor: isActive('/about-us') ? 'rgba(255, 255, 255, 0.15)' : 'transparent',
                backdropFilter: isActive('/about-us') ? 'blur(10px)' : 'none',
                border: isActive('/about-us') ? '1px solid rgba(255, 255, 255, 0.2)' : '1px solid transparent',
                '&:hover': {
                  backgroundColor: 'rgba(255, 255, 255, 0.1)',
                  transform: 'translateY(-1px)',
                  boxShadow: '0 4px 8px rgba(0,0,0,0.2)'
